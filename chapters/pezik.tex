...
\author{Piotr Pęzik\affiliation{University of Łódź}\orcid{}}
...
\tabref{tab:pezik:2} shows the top five adjectival collocates of the noun \textit{advantage} recorded in HASK EN (Pęzik 2014)\footnote{See also \url{http://pelcra.pl/hask\_en}.}, a combinatorial database precomputed from the original edition of the British National Corpus (BNC). The remaining columns of the table show a selection of strength of association and dispersion scores.
...
1  & v2-prep-v1-pobj->v0 & 254 & 3104 & number + of + factor\linebreak one + of + factor\linebreak depend + on + factor\\
